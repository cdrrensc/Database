...
\begin{itemize}
	\item exactly one : events -> discipline, events -> games
	\item 1 athlete comes twice -> 1 athlete, 2 participants
	\item comment all at least
	\item country doe not necessarily have a participant
